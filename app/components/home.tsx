...
const HomeSection = () => {
    return (
        <section className="bg-(--primary-blue) rounded-xl flex flex-col items-center p-10 gap-5">
            ...
            <a
                ...
                className="animate-bounce flex items-center text-white font-semibold rounded-3xl bg-linear-to-tr from-blue-600 to-blue-400 px-5 py-3 transition-transform transform hover:-translate-y-1"
            >
