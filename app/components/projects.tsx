...
const ProjectsSection = () => {
    return (
        <section id="projects" className="rounded-xl flex flex-col items-center gap-5">
            ...
            <div className="md:flex-row flex flex-col items-center justify-center p-10 rounded-xl bg-linear-to-r from-emerald-700 to-green-950 min-h-[80vh]">
                <div className="w-full flex flex-col gap-5 items-center md:items-start order-1 md:order-2">
                    <h1 className="text-white text-2xl font-semibold text-center md:text-left">PaintAR</h1>
                    <p className="text-white text-center md:text-left">An android application that allows its users to see how various paint colors will look in their own living spaces without painting the walls. This application was developed using Java, Kotlin, while implementing the OpenCV library for image processing.</p>
            ...
            <div className="md:flex-row flex flex-col items-center justify-center gap-5 p-10 rounded-xl bg-linear-to-r from-indigo-700 to-blue-950 min-h-[80vh]">
                <div className="w-full flex flex-col gap-5 items-center md:items-start order-1 md:order-2">
                    <h1 className="text-white text-2xl font-semibold text-center md:text-left">NU Laguna Queuing System</h1>
                    <p className="text-white text-center md:text-left">A queuing system built for the benefit of the students at National University Laguna. This system optimizes the queuing process for students availing of various student services, such as enrollment, cashier transactions, and registrar’s office assistance. This was developed using HTML, CSS, Bootstrap, jQuery, JavaScript, PHP, and MySQL.</p>
                ...
                <div className="w-full">
                    <img src="/NULQueue.png" alt="NULQueue"></img>
                </div>
            </div>
